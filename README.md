...
![Light Mode Home Dashboard](screenshots/light_mode.png)

### Dark Mode Home Dashboard
![Dark Mode Home Dashboard](screenshots/dark_mode.png)

### Redesigned Search Engine Picker
![Search Engine Picker Dialog](screenshots/search_picker.png)
